...
\item%
\jeolmlabel{/algebra/number-theory/ferma-euler-theorem-g8/1-r2/:problem:proof-2}%
\subproblem
...
\item
\jeolmlabel{/algebra/number-theory/ferma-euler-theorem-g8/1-r2/:problem:proof-4}%
...
\jeolmref{/algebra/number-theory/ferma-euler-theorem-g8/1-r2/:problem:proof-2},
и~докажите теорему Эйлера.
\\
\subproblem
Приведите рассуждения, аналогичные задаче~%
\jeolmref{/algebra/number-theory/ferma-euler-theorem-g8/1-r2/:problem:proof-4},
и~докажите теорему Эйлера.
...
\endgroup % \def\eulerphi \def\binom
